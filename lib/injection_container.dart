...
import 'package:news_app_clean_architecture_flutter/features/daily_news/data/repository/article_repository_impl.dart';
...
Future<void> initializeDependencies() async {
  ...
  sl.registerSingleton<RemovedArticleUseCase>(RemovedArticleUseCase(sl()));
